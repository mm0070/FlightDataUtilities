...
class TestUnitsModule(unittest.TestCase):
    ...
    def test__convert(self):
        ...
        data = {
            ...
            (1, FPS, KT): 0.592483801,
            (1, FPS, MPH): 0.681818,
            (1, FPS, FPM): 60.0,
            (1, KT, FPS): 1.68781,
            (1, MPH, FPS): 1.46667,
            (1, FPM, FPS): 0.016666666666666666,
            (1, KT, METER_S): 0.51444,
            (1, MPH, METER_S): 0.44704,
            (1, FPM, METER_S): 0.00508,
            (1, FPS, METER_S): 0.3048,
            (1, METER_S, KT): 1.94384,
            (1, METER_S, MPH): 2.23694,
            (1, METER_S, FPM): 196.850394,
            (1, METER_S, FPS): 3.28084,
            # Temperature:
